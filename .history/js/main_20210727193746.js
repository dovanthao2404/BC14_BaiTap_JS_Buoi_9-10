...
document.querySelector("#btnTimNV").addEventListener("click", findStaffByClassification(1)
document.querySelector("#searchName").addEventListener("input", findStaffByClassification(1)
...
function findStaffByClassification(1(page) {

  var content = document.querySelector("#searchName").value;
  var listStaffFinded = staffManager.findStaffByClassification(1(content);
