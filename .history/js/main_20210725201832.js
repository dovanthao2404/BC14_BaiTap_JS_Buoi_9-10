...
document.querySelector("#btnTimNV").addEventListener("click", handleFindStaff)
...
function handleFindStaff() {
  var classification = document.querySelector("#searchName").value;
  var staffTemp = staffManager.findStaffByClassification(classification);
  pwdPage = 1;
  showListStaff(staffManager);
}