...
function showListStaff() {
  ...
  listStaff.forEach(function (staff) {
    ...
    <tr>
      ...
      <th>
        <button class="btn bt-warning" data-action="change" data-account="${staff.account}">Sửa</button>
        <button class="btn bt-warning" data-action="delete" data-account="${staff.account}">Xóa</button>
      </th>
    </tr>
    `
  })
